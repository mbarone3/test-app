...
namespace TestApp {
    ...
    public static class Program {
        ...
        public static int Main(string[] args) {
            ...
            // Ensure that we are the only instance of the Test App currently running.
            var instance = new Mutex(initiallyOwned: false, name: "single instance: TestApp");
            ...
            try {
                ...
                // Parse arguments and do the appropriate thing.
                {
                    ...
                    Console.WriteLine(value: "Test App is already running. Aborting.");
        ...
        private static RootCommand GetCommandLineParser() {
            ...
            optJiggling.Argument.SetDefaultValue(value: Settings.Default.JiggleOnStartup);
